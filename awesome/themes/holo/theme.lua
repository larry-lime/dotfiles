...
-- Randomly choose a wallpaper from the ~/.config/awesome/images directory
-- First get a randomly generated integer
-- Get the number of files in the images directory
-- Get a random number from 0 until the last image in the directory
-- Iterate over all the filenames and index the file name and return the name of the chosen wallpaper
